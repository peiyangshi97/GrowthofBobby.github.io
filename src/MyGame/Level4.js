...
function Level4() {
    ...
    this.kAwin = "assets/pictures/Alicewin.png";
    this.kBwin = "assets/pictures/Bobwin.png";
...
Level4.prototype.unloadScene = function () {
    ...
    if (this.mRestart === true) {
        ...
        {
            case 1:
                nextLevel = new End(this.kAwin, 4);   //bob胜利
                break;
            case 2:
                nextLevel = new End(this.kBwin, 4);   //Alice胜利
                break;
        }
...
Level4.prototype.cameraUpdate = function () {
    ...
    for (let i = 0; i < this.mAllHeros.size(); i++) {
        ...
        maxR < this.mAllHeros.getObjectAt(i).getHeroRadius() ? this.mAllHeros.getObjectAt(i).getHeroRadius() : maxR;
        maxX < this.mAllHeros.getObjectAt(i).getXform().getXPos() ? this.mAllHeros.getObjectAt(i).getXform().getXPos() : maxX;
        minX > this.mAllHeros.getObjectAt(i).getXform().getXPos() ? this.mAllHeros.getObjectAt(i).getXform().getXPos() : minX;
        maxY < this.mAllHeros.getObjectAt(i).getXform().getYPos() ? this.mAllHeros.getObjectAt(i).getXform().getYPos() : maxY;
        minY > this.mAllHeros.getObjectAt(i).getXform().getYPos() ? this.mAllHeros.getObjectAt(i).getXform().getYPos() : minY;
    }
    ...
    for (let i = 0; i < this.mAllComps.size(); i++) {
        ...
        maxR < this.mAllComps.getObjectAt(i).getHeroRadius() ? this.mAllComps.getObjectAt(i).getHeroRadius() : maxR;
        maxX < this.mAllComps.getObjectAt(i).getXform().getXPos() ? this.mAllComps.getObjectAt(i).getXform().getXPos() : maxX;
        minX > this.mAllComps.getObjectAt(i).getXform().getXPos() ? this.mAllComps.getObjectAt(i).getXform().getXPos() : minX;
        maxY < this.mAllComps.getObjectAt(i).getXform().getYPos() ? this.mAllComps.getObjectAt(i).getXform().getYPos() : maxY;
        minY > this.mAllComps.getObjectAt(i).getXform().getYPos() ? this.mAllComps.getObjectAt(i).getXform().getYPos() : minY;
    }
